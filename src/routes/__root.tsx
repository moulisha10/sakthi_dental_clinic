  ...
  head: () => ({
    meta: [
      ...
      { title: "Sakthi Dental Clinic | Dental Care in Hosur" },
      {
        name: "description",
        content:
          "Specialized dental care for women, children and families in Hosur, Tamil Nadu. Led by Dr. Anupriya with 20+ years of experience.",
      },
      { name: "author", content: "Sakthi Dental Clinic" },
      { property: "og:title", content: "Sakthi Dental Clinic | Dental Care in Hosur" },
      {
        property: "og:description",
        content: "Compassionate, expert-led dental services in a modern and welcoming environment.",
      },
